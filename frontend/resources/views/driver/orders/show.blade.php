                    ...
                    <div class="mb-3 pb-3 border-bottom">
                        ...
                        <div class="mb-2">
                            ...
                            @php
                                ...
                                if ($order->delivery) {
                                    $deliveryAddress = trim($order->delivery->delivery_address ?? '');
                                ...
                                if (empty($address)) {
                                    $anyAddress = $order->user->addresses()->first();
                                    if ($anyAddress) {
                                        $address = trim(collect([
                                ...
                                if (empty($address) && !empty($order->notes)) {
                                    if (preg_match('/Address:\s*(.+?)(?:[;,]|$)/i', $order->notes, $matches)) {
