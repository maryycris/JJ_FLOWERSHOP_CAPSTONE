                ...
                <div class="card-body">
                    ...
                    <div class="success-message">
                        ...
                        <div class="message-content">
                            ...
                            <span>Order {{ $order->so_number_format }} has been validated, invoice generated, and driver assigned for delivery.</span>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered">
                                ...
                                <tfoot>
                                    ...
                                    @if($shippingFee > 0)
                                    <tr>
                                        <td colspan="3" class="text-end border-0"><strong>Shipping Fee:</strong></td>
                                    ...
                                    <tr class="table-light" style="border-top: 2px solid #dee2e6;">
                                        ...
                                        <td class="text-end border-0"><strong>₱{{ number_format($grandTotal, 2) }}</strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
