        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="{{ route('admin.notifications.index') }}" class="text-white text-decoration-none @if(request()->routeIs('admin.notifications.*')) active @endif" title="Notifications">
                <span class="nav-icon-wrapper">
                    ...
                    @if(($adminNavCounts['unread_notifications'] ?? 0) > 0)
                        <span class="nav-badge">{{ $formatBadge($adminNavCounts['unread_notifications']) }}</span>
                    @endif
                </span>
            </a>
            ...
            <a href="{{ route('admin.chatbox') }}" class="text-white text-decoration-none @if(request()->routeIs('admin.chatbox')) active @endif" title="Chat">
                <span class="nav-icon-wrapper">
                    ...
                    @if(($adminNavCounts['unread_messages'] ?? 0) > 0)
                        <span class="nav-badge">{{ $formatBadge($adminNavCounts['unread_messages']) }}</span>
                    @endif
                </span>
            </a>
    ...
    <div class="navbar-admin-links">
        <a href="{{ route('admin.products.index') }}" class="nav-link @if(request()->routeIs('admin.products.*')) active @endif">
            <span class="nav-icon-wrapper">
                ...
                @if(($adminNavCounts['pending_products'] ?? 0) > 0)
                    <span class="nav-badge">{{ $formatBadge($adminNavCounts['pending_products']) }}</span>
                @endif
            </span>
            Product Catalog
        </a>
        ...
        <a href="{{ route('admin.sales-orders.index') }}" class="nav-link @if(request()->routeIs('admin.sales-orders.*') || request()->routeIs('admin.orders.index')) active @endif">
            <span class="nav-icon-wrapper">
                <i class="bi bi-cart"></i>
                @if(($adminNavCounts['pending_sales_orders'] ?? 0) > 0)
                    <span class="nav-badge">{{ $formatBadge($adminNavCounts['pending_sales_orders']) }}</span>
                @endif
            </span>
            Sales Orders
        </a>
        ...
        <a href="{{ route('admin.customize.index') }}" class="nav-link @if(request()->routeIs('admin.customize.*')) active @endif">
            <span class="nav-icon-wrapper">
                <i class="bi bi-palette"></i>
                @if(($adminNavCounts['pending_customize_items'] ?? 0) > 0)
                    <span class="nav-badge">{{ $formatBadge($adminNavCounts['pending_customize_items']) }}</span>
                @endif
            </span>
            Customize
        </a>
