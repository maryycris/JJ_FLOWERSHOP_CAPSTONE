...
<head>
    ...
    <style>
        ...
        .driver-menu .nav-link { color: #234c23; font-size: 1.1rem; position: relative; }
...
<body>
@php
    $driverNavCounts = $driverNavCounts ?? [
    ...
    <div class="driver-menu shadow" id="driverMenu">
        ...
        <ul class="nav flex-column px-3">
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('driver.orders.index') }}" class="nav-link">
                    Orders
                    @if(($driverNavCounts['active_deliveries'] ?? 0) > 0)
                        <span class="nav-badge">{{ ($driverNavCounts['active_deliveries'] > 99) ? '99+' : $driverNavCounts['active_deliveries'] }}</span>
                    @endif
                </a>
            </li>
