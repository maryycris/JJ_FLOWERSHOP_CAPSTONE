            ...
            <div class="container-fluid px-4" style="padding-top: 4px; padding-bottom: 6px;">
                <div class="d-flex justify-content-between" style="align-items: flex-start;">
                    ...
                    <div class="d-flex flex-column flex-grow-1" style="max-width: 1000px; margin: 0 20px;">
                        ...
                        <a href="{{ route('customer.notifications.index') }}" class="nav-link text-white d-flex align-items-center gap-2 @if(request()->routeIs('customer.notifications.index')) active @endif" style="font-size: 0.95rem;">
                            <span class="nav-icon-wrapper">
                                ...
                                @if($customerUnreadNotifications > 0)
                                    <span class="nav-badge">{{ $customerUnreadNotifications > 99 ? '99+' : $customerUnreadNotifications }}</span>
                                @endif
                            </span>
                            Notifications
                        </a>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-4 customer-right-icons">
                            ...
                            <a href="{{ route('customer.cart.index') }}" class="icon-btn text-white position-relative @if(request()->routeIs('customer.cart.index')) active @endif" title="Cart">
                                <span class="nav-icon-wrapper">
                                    <i class="bi @if(request()->routeIs('customer.cart.index')) bi-cart-fill @else bi-cart @endif" style="font-size: 1.35rem;"></i>
                                    @if($customerCartItems > 0)
                                        <span class="nav-badge">{{ $customerCartItems > 99 ? '99+' : $customerCartItems }}</span>
                                    @endif
                                </span>
                            </a>
                        </div>
        ...
        <div class="mobile-bottom-nav d-lg-none">
            ...
            <a href="{{ route('customer.notifications.index') }}" class="nav-item @if(request()->routeIs('customer.notifications.index')) active @endif">
                <span class="nav-icon-wrapper" style="font-size: 1.2rem;">
                    <i class="bi @if(request()->routeIs('customer.notifications.index')) bi-bell-fill @else bi-bell @endif"></i>
                    @if($customerUnreadNotifications > 0)
                        <span class="nav-badge" style="top:-4px; right:-8px;">{{ $customerUnreadNotifications > 99 ? '99+' : $customerUnreadNotifications }}</span>
                    @endif
                </span>
