...
// Note: Public API routes have been moved to routes/api.php
// These routes are now accessible via /api/* prefix automatically
...
// Note: Geo Optimization routes have been moved to routes/api.php
// Access via: /api/geo/content, /api/geo/location, /api/geo/homepage-products
