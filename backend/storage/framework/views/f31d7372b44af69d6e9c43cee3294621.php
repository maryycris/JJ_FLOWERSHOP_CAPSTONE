        ...
        <div class="col-lg-8 col-12">
            <div class="bg-white rounded-3 p-3 p-md-4 scrollable-content cart-items-section" style="box-shadow: none;">
                    ...
                    <table class="table align-middle mb-0" style="background: #fff;">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="cart-item" data-item-id="<?php echo e($item->id); ?>">
                                ...
                                <td>
                                    <?php if($item->item_type === 'custom_bouquet'): ?>
                                        ₱<span class="item-unit-price"><?php echo e(number_format($item->customBouquet ? ($item->customBouquet->unit_price ?? $item->customBouquet->total_price) : 0, 2)); ?></span>
                                    <?php else: ?>
                                        ₱<span class="item-unit-price"><?php echo e(number_format($item->product ? $item->product->price : 0, 2)); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($item->item_type === 'custom_bouquet'): ?>
                                        ₱<span class="item-total-price"><?php echo e(number_format($item->quantity * ($item->customBouquet ? ($item->customBouquet->unit_price ?? $item->customBouquet->total_price) : 0), 2)); ?></span>
                                    <?php else: ?>
                                        ₱<span class="item-total-price"><?php echo e(number_format($item->quantity * ($item->product ? $item->product->price : 0), 2)); ?></span>
                                    <?php endif; ?>
                                </td>
                ...
                <div class="d-lg-none" id="mobileCartItemsContainer">
                    <?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="cart-item-mobile mb-3 p-3 bg-light rounded-3" data-item-id="<?php echo e($item->id); ?>" style="border: 1px solid #e9ecef;">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(asset('storage/' . $item->product->image)); ?>" style="width: 50px; height: 50px; object-fit: cover; border-radius: 8px; margin-right: 12px;">
                                    <span style="font-weight: 500; flex: 1;"><?php echo e($item->product->name); ?></span>
                                <?php endif; ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="input-group quantity-control-small" style="width: auto;">
                                    <button class="btn btn-outline-success btn-sm quantity-btn" type="button" data-action="decrement">-</button>
                                    <input type="text" class="form-control form-control-sm text-center quantity-input" value="<?php echo e($item->quantity); ?>" readonly style="width: 45px;">
                                    <button class="btn btn-outline-success btn-sm quantity-btn" type="button" data-action="increment">+</button>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/customer/cart/index.blade.php ENDPATH**/ ?>