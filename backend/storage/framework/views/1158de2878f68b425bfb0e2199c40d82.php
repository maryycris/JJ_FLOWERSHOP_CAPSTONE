...
<div class="invoice-box">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php $__currentLoopData = $order->customBouquets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bouquet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $quantity = $bouquet->pivot->quantity ?? ($bouquet->quantity ?? 1);
                $unitPrice = $bouquet->unit_price;
                if ($unitPrice === null) {
                    $unitPrice = $bouquet->total_price ?? 0;
                    $unitPrice = $quantity > 0 ? $unitPrice / $quantity : 0;
                }
                $lineTotal = $unitPrice * $quantity;
                $subtotal += $lineTotal;
            ?>
            <tr class="item">
                <td><?php echo e($bouquet->bouquet_description ?? 'Custom Bouquet #' . $bouquet->id); ?></td>
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/orders/invoice.blade.php ENDPATH**/ ?>