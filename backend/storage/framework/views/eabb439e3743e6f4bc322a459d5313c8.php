                ...
                <div class="col-md-6">
                    <a href="<?php echo e(route('admin.inventory.index')); ?>" class="text-decoration-none">
                        <div class="card h-100 restock-alert-card">
                            ...
                            <div class="card-body">
                                <?php
                                    $hasAlerts = (isset($restockProducts) && count($restockProducts)) || (isset($overstockProducts) && count($overstockProducts));
                                ?>
                                <?php if($hasAlerts): ?>
                                    <?php if(isset($restockProducts) && count($restockProducts)): ?>
                                        <?php $__currentLoopData = $restockProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                                <span><?php echo e($product->name); ?></span>
                                                <span class="badge bg-danger"><?php echo e($product->stock); ?> left (Min: <?php echo e($product->reorder_min); ?>)</span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                    <?php if(isset($overstockProducts) && count($overstockProducts)): ?>
                                        <?php $__currentLoopData = $overstockProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                                <span><?php echo e($product->name); ?></span>
                                                <span class="badge bg-warning text-dark">Exceeds by <?php echo e($product->stock - $product->reorder_max); ?> (Max: <?php echo e($product->reorder_max); ?>)</span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>