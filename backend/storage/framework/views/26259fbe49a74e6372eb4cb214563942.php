                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.sales-orders.show', $invoice->order_id)); ?>" class="order-link">
                                            <?php echo e($invoice->order->so_number_format ?? 'SO-' . str_pad($invoice->order_id, 5, '0', STR_PAD_LEFT)); ?>
                                    ...
                                    <td>
                                        <?php
                                            // Calculate correct total from order data
                                            ...
                                            // Use calculated total if it's different from stored total (for existing invoices with wrong values)
                                            $displayTotal = abs($calculatedTotal - $invoice->total_amount) > 0.01 ? $calculatedTotal : $invoice->total_amount;
                                        ?>
