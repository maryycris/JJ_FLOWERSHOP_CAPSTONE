...
@media (max-width: 650px) {
    /* Hide global footer on customize page only (mobile) */
    ...
    /* Make the main content column wider on mobile (green box container) */
    .col-10.col-xl-9 { width: 98% !important; }
    .col-10.col-xl-9 > .row { margin-left: 0 !important; margin-right: 0 !important; }

    /* Reduce paddings inside the green box for cleaner mobile look */
    .customize-shell { padding: .5rem !important; border-radius: .75rem !important; }
    .order-2.order-lg-1 { padding: .5rem !important; }
    .order-1.order-lg-2 { padding: .5rem !important; }
}
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/products/bouquet-customize.blade.php ENDPATH**/ ?>