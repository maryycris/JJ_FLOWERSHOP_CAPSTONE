    ...
    <div class="container" style="max-width: 1400px;">
        ...
        <div class="row justify-content-center">
            ...
            <?php if($latestProof): ?>
                        <div class="mb-4">
                            <h5 class="mb-3" style="color: #2c3e50; font-weight: 600;">
                                <i class="fas fa-receipt me-2 text-primary"></i>Payment Proof
                            </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <p class="mb-2"><strong>Reference Number:</strong> 
                                                <span class="text-muted"><?php echo e($latestProof->reference_number ?? 'N/A'); ?></span>
                                            </p>
                                            ...
                                            <p class="mb-0"><strong>Status:</strong> 
                                                <?php
                                                    $statusColor = match($latestProof->status) {
                                                        'approved' => '#28a745',
                                                        'pending' => '#ffc107',
                                                        'rejected' => '#dc3545',
                                                        default => '#6c757d'
                                                    };
                                                    $statusTextColor = $latestProof->status === 'pending' ? 'black' : 'white';
                                                ?>
                                                <span class="badge" style="background-color: <?php echo e($statusColor); ?>; color: <?php echo e($statusTextColor); ?>;">
                                                    <?php echo e(ucfirst($latestProof->status)); ?>

                                                </span>
                                            </p>
                                            <?php if($latestProof->status === 'pending'): ?>
                                                <p class="text-muted small mt-2 mb-0">
                                                    <i class="fas fa-clock me-1"></i>Waiting for admin/clerk verification
                                                </p>
                                            <?php elseif($latestProof->status === 'approved'): ?>
                                                <p class="text-success small mt-2 mb-0">
                                                    <i class="fas fa-check-circle me-1"></i>Payment verified! Your order is being processed.
                                                </p>
                                            <?php elseif($latestProof->status === 'rejected'): ?>
                                                <p class="text-danger small mt-2 mb-0">
                                                    <i class="fas fa-times-circle me-1"></i>Payment proof was rejected. Please upload a new one.
                                                </p>
                                            <?php endif; ?>
                                        </div>
                                        <div class="col-md-6">
                                            <?php if($latestProof->image_path): ?>
                                                <p class="mb-2"><strong>Screenshot/Receipt:</strong></p>
                                                <img src="<?php echo e(asset('storage/' . $latestProof->image_path)); ?>" 
                                                     alt="Payment Proof" 
                                                     class="img-fluid rounded" 
                                                     style="max-width: 100%; max-height: 200px; border: 1px solid #ddd; cursor: pointer;"
                                                     onclick="window.open('<?php echo e(asset('storage/' . $latestProof->image_path)); ?>', '_blank')"
            ...
            <?php if(in_array($order->payment_method, ['gcash','paymaya']) && $order->payment_status === 'unpaid' && (!$latestProof || $latestProof->status === 'rejected')): ?>
                        <div class="mb-4">
                            <h5 class="mb-3" style="color: #2c3e50; font-weight: 600;">
                    ...
                    <form action="<?php echo e(route('customer.orders.uploadPaymentProof', $order->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="reference_number" name="reference_number" maxlength="100" value="<?php echo e(old('reference_number')); ?>">
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label">Upload Screenshot/Receipt <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" id="image" name="image" accept="image/*" required>
                            <small class="text-muted">Accepted formats: JPG, PNG, GIF, WEBP (Max: 4MB)</small>
                        </div>
                        <button type="submit" class="btn btn-success w-100">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/customer/orders/show.blade.php ENDPATH**/ ?>