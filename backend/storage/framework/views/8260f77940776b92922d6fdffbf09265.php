                    ...
                    <?php else: ?>
                        ...
                        <div class="carousel-item <?php if($i === 0): ?> active <?php endif; ?> text-center" style="position: relative;">
                            ...
                            <?php if($isPromotedOutOfStock): ?>
                                <small class="text-muted d-block" style="font-size: 0.7rem;">Insufficient materials</small>
                                <span class="badge bg-danger mt-1" style="font-size: 0.6rem;">OUT OF STOCK</span>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>