...
<body>
    <div id="app">
        <?php
            $customerNavCounts = $customerNavCounts ?? [];
            $customerUnreadNotifications = $customerNavCounts['unread_notifications'] ?? ($unreadCount ?? 0);
            $customerCartItems = $customerNavCounts['cart_items'] ?? 0;
        ?>
            ...
            <div class="container-fluid px-4" style="padding-top: 4px; padding-bottom: 6px;">
                <div class="d-flex justify-content-between" style="align-items: flex-start;">
                    ...
                    <div class="d-flex flex-column flex-grow-1" style="max-width: 1000px; margin: 0 20px;">
                        ...
                        <a href="<?php echo e(route('customer.notifications.index')); ?>" class="nav-link text-white d-flex align-items-center gap-2 <?php if(request()->routeIs('customer.notifications.index')): ?> active <?php endif; ?>" style="font-size: 0.95rem;">
                            <span class="nav-icon-wrapper">
                                ...
                                <?php if($customerUnreadNotifications > 0): ?>
                                    <span class="nav-badge"><?php echo e($customerUnreadNotifications > 99 ? '99+' : $customerUnreadNotifications); ?></span>
                                <?php endif; ?>
                            </span>
                            Notifications
                        </a>
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-4 customer-right-icons">
                            ...
                            <a href="<?php echo e(route('customer.cart.index')); ?>" class="icon-btn text-white position-relative <?php if(request()->routeIs('customer.cart.index')): ?> active <?php endif; ?>" title="Cart">
                                <span class="nav-icon-wrapper">
                                    <i class="bi <?php if(request()->routeIs('customer.cart.index')): ?> bi-cart-fill <?php else: ?> bi-cart <?php endif; ?>" style="font-size: 1.35rem;"></i>
                                    <?php if($customerCartItems > 0): ?>
                                        <span class="nav-badge"><?php echo e($customerCartItems > 99 ? '99+' : $customerCartItems); ?></span>
                                    <?php endif; ?>
                                </span>
                            </a>
                        </div>
        ...
        <div class="mobile-bottom-nav d-lg-none">
            ...
            <a href="<?php echo e(route('customer.notifications.index')); ?>" class="nav-item <?php if(request()->routeIs('customer.notifications.index')): ?> active <?php endif; ?>">
                <span class="nav-icon-wrapper" style="font-size: 1.2rem;">
                    <i class="bi <?php if(request()->routeIs('customer.notifications.index')): ?> bi-bell-fill <?php else: ?> bi-bell <?php endif; ?>"></i>
                    <?php if($customerUnreadNotifications > 0): ?>
                        <span class="nav-badge" style="top:-4px; right:-8px;"><?php echo e($customerUnreadNotifications > 99 ? '99+' : $customerUnreadNotifications); ?></span>
                    <?php endif; ?>
                </span>
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/layouts/customer_app.blade.php ENDPATH**/ ?>