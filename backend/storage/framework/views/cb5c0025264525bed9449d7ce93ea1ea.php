            ...
            <div class="col-12 col-lg-8 col-xl-6 order-1 order-lg-1 payment-methods-section">
                <div class="bg-white rounded-3 p-3 p-md-4 mb-3 mb-lg-4 scrollable-content payment-methods-card" style="box-shadow: none; overflow-y: auto;">
                    ...
                    <div class="d-flex justify-content-between flex-wrap gap-2 mt-4">
                        <a href="<?php echo e(route('customer.checkout.index')); ?>" class="btn btn-outline-success btn-sm">
                            &larr; Return
                        </a>
                ...
                <div class="bg-white rounded-3 p-3 p-md-4 purchase-summary-card" style="box-shadow: none;">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <?php if($item->item_type === 'custom_bouquet'): ?>
                            ...
                            <div class="text-end">
                                <div style="font-weight: 600; color: #222;">₱<?php echo e(number_format($item->quantity * ($item->customBouquet ? ($item->customBouquet->unit_price ?? $item->customBouquet->total_price) : 0), 2)); ?></div>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="text-end">
                                <div style="font-weight: 600; color: #222;">₱<?php echo e(number_format($item->quantity * ($item->product ? $item->product->price : 0), 2)); ?></div>
                            </div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <?php if($loyaltyDiscount > 0): ?>
                                            ...
                                            <div class="alert alert-success py-2 px-3 mb-2">
                                                ...
                                                <?php if($discountedItem->item_type === 'custom_bouquet'): ?>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/customer/checkout/payment_method.blade.php ENDPATH**/ ?>