...
<?php
    ...
    $formatBadge = fn($value) => $value > 99 ? '99+' : $value;
?>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-white text-decoration-none <?php if(request()->routeIs('admin.notifications.*')): ?> active <?php endif; ?>" title="Notifications">
                <span class="nav-icon-wrapper">
                    ...
                    <?php if(($adminNavCounts['unread_notifications'] ?? 0) > 0): ?>
                        <span class="nav-badge"><?php echo e($formatBadge($adminNavCounts['unread_notifications'])); ?></span>
                    <?php endif; ?>
                </span>
            </a>
            ...
            <a href="<?php echo e(route('admin.chatbox')); ?>" class="text-white text-decoration-none <?php if(request()->routeIs('admin.chatbox')): ?> active <?php endif; ?>" title="Chat">
                <span class="nav-icon-wrapper">
                    ...
                    <?php if(($adminNavCounts['unread_messages'] ?? 0) > 0): ?>
                        <span class="nav-badge"><?php echo e($formatBadge($adminNavCounts['unread_messages'])); ?></span>
                    <?php endif; ?>
                </span>
            </a>
...
<div class="navbar-admin-links-row">
    <div class="navbar-admin-links">
        <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-link <?php if(request()->routeIs('admin.products.*')): ?> active <?php endif; ?>">
            <span class="nav-icon-wrapper">
                <i class="bi bi-grid"></i>
                <?php if(($adminNavCounts['pending_products'] ?? 0) > 0): ?>
                    <span class="nav-badge"><?php echo e($formatBadge($adminNavCounts['pending_products'])); ?></span>
                <?php endif; ?>
            </span>
            Product Catalog
        </a>
        ...
        <a href="<?php echo e(route('admin.sales-orders.index')); ?>" class="nav-link <?php if(request()->routeIs('admin.sales-orders.*') || request()->routeIs('admin.orders.index')): ?> active <?php endif; ?>">
            <span class="nav-icon-wrapper">
                <i class="bi bi-cart"></i>
                <?php if(($adminNavCounts['pending_sales_orders'] ?? 0) > 0): ?>
                    <span class="nav-badge"><?php echo e($formatBadge($adminNavCounts['pending_sales_orders'])); ?></span>
                <?php endif; ?>
            </span>
            Sales Orders
        </a>
        ...
        <a href="<?php echo e(route('admin.customize.index')); ?>" class="nav-link <?php if(request()->routeIs('admin.customize.*')): ?> active <?php endif; ?>">
            <span class="nav-icon-wrapper">
                <i class="bi bi-palette"></i>
                <?php if(($adminNavCounts['pending_customize_items'] ?? 0) > 0): ?>
                    <span class="nav-badge"><?php echo e($formatBadge($adminNavCounts['pending_customize_items'])); ?></span>
                <?php endif; ?>
            </span>
            Customize
        </a>
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\frontend\resources\views/layouts/admin_app.blade.php ENDPATH**/ ?>