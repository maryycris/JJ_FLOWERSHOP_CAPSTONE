        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" style="background: #e6f4ea;">
                    <h3 class="card-title mb-0" style="font-size: 1.1rem; font-weight: 600;">Order Details - {{ $order->so_number_format }}</h3>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Order Number:</strong> {{ $order->so_number_format }}</p>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="proofOfDeliveryModalLabel" style="font-size: 0.95rem;">
                    <i class="fas fa-camera me-2"></i>Proof of Delivery - Order {{ $order->so_number_format }}
                </h5>
            ...
            <div class="modal-body text-center" style="padding: 1rem;">
                ...
                <div class="row text-start" style="font-size: 0.85rem; margin-top: 0.5rem;">
                    <div class="col-md-6">
                        <p style="margin-bottom: 0.25rem;"><strong>Order #:</strong> {{ $order->so_number_format }}</p>
