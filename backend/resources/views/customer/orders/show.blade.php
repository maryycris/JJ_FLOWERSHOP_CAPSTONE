...
<div class="pt-0 order-details-container" style="background: #f4faf4; min-height: 100vh;">
    <div class="container" style="max-width: 1400px;">
        ...
        <div class="row justify-content-center">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 mb-md-0">
                                            <p class="mb-2"><strong>Reference Number:</strong> 
                                                <span class="text-muted">{{ $latestProof->reference_number ?? 'N/A' }}</span>
                                            </p>
                                            ...
                                            @elseif($latestProof->status === 'rejected')
                                        ...
                                        <div class="col-md-6">
                                            @if($latestProof->image_path)
                                                ...
                                                <img src="{{ asset('storage/' . $latestProof->image_path) }}" 
                                                     alt="Payment Proof" 
                                                     class="img-fluid rounded" 
                                                     style="max-width: 100%; max-height: 200px; border: 1px solid #ddd; cursor: pointer;"
                                                     onclick="window.open('{{ asset('storage/' . $latestProof->image_path) }}', '_blank')"
            ...
            @if(in_array($order->payment_method, ['gcash','paymaya']) && $order->payment_status === 'unpaid' && (!$latestProof || $latestProof->status === 'rejected'))
                        <div class="mb-4">
                            <h5 class="mb-3" style="color: #2c3e50; font-weight: 600;">
                    ...
                    <form action="{{ route('customer.orders.uploadPaymentProof', $order->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="reference_number" name="reference_number" maxlength="100" value="{{ old('reference_number') }}">
                        </div>
                        <div class="mb-3">
