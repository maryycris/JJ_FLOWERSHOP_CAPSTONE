                        ...
                        <div class="tab-pane fade show active" id="new" role="tabpanel" aria-labelledby="new-tab">
                            ...
                            <div class="row g-0 border mb-3" style="border-color:#d9ecd9 !important;">
                                ...
                                <div class="col-md-3" style="background:#e6f5e6;">
                                    ...
                                    <div class="p-3">
                                        <input type="text" class="form-control form-control-sm" id="deliveryAddress" value="<?php echo e($order->delivery->delivery_address ?? ''); ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-2" style="background:#e6f5e6;">
                                    <div class="p-3 fw-semibold" style="border-bottom:1px solid #d9ecd9;">Order Date</div>
                                    <div class="p-3">
                                        <input type="date" class="form-control form-control-sm" id="orderDate" value="<?php echo e($order->created_at->format('Y-m-d')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-2" style="background:#e6f5e6;">
                            ...
                            <div class="mt-3">
                                        ...
                                        <tbody id="orderLineBody">
                                            <?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm quantity-input" value="<?php echo e($product->pivot->quantity); ?>" min="1">
                                                    </td>
                                                    <td>
                                                        <input type="number" class="form-control form-control-sm delivered-input" value="<?php echo e($product->pivot->quantity); ?>" min="0">
                                                    </td>
                                                    <td>
                                ...
                                <div class="text-end mt-2 fw-semibold">Total: ₱<span id="totalPrice"><?php echo e(number_format($order->total_price, 2)); ?></span></div>
                            </div>
                        </div>
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    window.location.href = '<?php echo e(route("admin.orders.walkin.validate", $order->id)); ?>';
                });
            }, 1500);
        } else {
    ...
    Swal.fire({
        ...
        html: `
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="emailSubject" value="Invoice #<?php echo e(sprintf('%05d', $order->id)); ?> - J'J Flower Shop" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Message</label>
                <textarea class="form-control" id="emailMessage" rows="3" placeholder="Optional message...">Dear Customer,

Please find attached your invoice for order #<?php echo e(sprintf('%05d', $order->id)); ?>.
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                Swal.fire({
                    ...
                    window.location.href = '<?php echo e(route("admin.orders.index", ["type" => "walkin"])); ?>';
                });
            }, 1500);
        }
    });
