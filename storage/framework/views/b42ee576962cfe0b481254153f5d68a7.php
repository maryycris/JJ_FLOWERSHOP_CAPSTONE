                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div>
                                <div class="nav nav-tabs border-0" id="orderTabs" role="tablist">
                                    <a href="<?php echo e(route('admin.orders.create')); ?>" class="nav-link active bg-light" id="new-tab" style="font-size: 0.9rem;">
                                        New
                                    </a>
                                ...
                                <?php if($soNumber): ?>
                                <div class="mt-2">
                                    <h5 class="mb-0 text-primary fw-bold" id="soNumberDisplay" style="font-size: 1rem;"><?php echo e($soNumber); ?></h5>
                                </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="tab-pane fade show active" id="new" role="tabpanel" aria-labelledby="new-tab">
                            ...
                            <div class="row g-0 border mb-3" style="border-color:#d9ecd9 !important;">
                                <div class="col-md-2" style="background:#e6f5e6;">
                                    ...
                                    <div class="p-3">
                                        <input type="text" class="form-control form-control-sm input-sm" id="customerName" placeholder="Enter customer name" value="<?php echo e($customerName); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2" style="background:#e6f5e6;">
                                    ...
                                    <div class="p-3">
                                        <input type="date" class="form-control form-control-sm input-sm" id="orderDate" value="<?php echo e($order->created_at->format('Y-m-d')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 px-3">
                                        ...
                                        <tbody id="orderLineBody" class="table-body">
                                            <?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td style="padding: 0.4rem 0.75rem;">
                                                        <input type="text" class="form-control form-control-sm description-input input-sm" value="<?php echo e($product->description); ?>">
                                                    </td>
                                                    <td style="padding: 0.4rem 0.75rem;">
                                                        <input type="number" class="form-control form-control-sm quantity-input input-sm" value="<?php echo e($product->pivot->quantity); ?>" min="1">
                                                    </td>
                                                    <td style="padding: 0.4rem 0.75rem;">
                                                    ...
                                                    <td style="padding: 0.4rem 0.75rem;">
                                                        <input type="number" class="form-control form-control-sm unit-price-input input-sm" value="<?php echo e($product->price); ?>" min="0" step="0.01">
                                                    </td>
                                                    <td style="padding: 0.4rem 0.75rem;">
                                ...
                                <button type="button" class="btn btn-outline-secondary btn-sm-custom" id="deliveryBtn">
                                    ...
                                    <div class="fw-semibold" style="font-size: 0.95rem;">
                                        Total: ₱<span id="totalPrice"><?php echo e(number_format($order->total_price, 2)); ?></span>
                                    </div>
                                </div>
                                            ...
                                            <div class="card border-success" style="border-width: 2px;">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="deliveryDate" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <select class="form-select" id="categoryFilter">
                            ...
                            <?php $__currentLoopData = \App\Models\CatalogProduct::distinct()->pluck('category'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($category): ?>
                ...
                <div class="row" id="productsGrid">
                    <?php $__currentLoopData = \App\Models\CatalogProduct::where('status', true)->where('is_approved', true)->whereIn('category', ['Bouquets', 'Packages', 'Gifts', 'Other Offers'])->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <div class="col-md-4 mb-3 product-card" data-name="<?php echo e(strtolower($product->name)); ?>" data-category="<?php echo e(strtolower($product->category ?? '')); ?>">
                            <div class="card h-100 product-item <?php echo e($isOutOfStock ? 'out-of-stock' : ''); ?>" data-product-id="<?php echo e($product->id); ?>" data-product-name="<?php echo e($product->name); ?>" data-product-price="<?php echo e($product->price); ?>" data-product-description="<?php echo e($product->description); ?>">
                                <!-- Product Image -->
                                <div class="card-img-top-container position-relative" style="height: 200px; overflow: hidden; background: #f8f9fa;">
                                    <?php if($product->image): ?>
                                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" class="card-img-top" alt="<?php echo e($product->name); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                    <?php else: ?>
                                ...
                                <div class="card-body">
                                    <h6 class="card-title <?php echo e($isOutOfStock ? 'text-muted' : ''); ?>"><?php echo e($product->name); ?></h6>
                                    <p class="card-text text-muted small"><?php echo e($product->description); ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="fw-bold <?php echo e($isOutOfStock ? 'text-muted' : 'text-success'); ?>">₱<?php echo e(number_format($product->price, 2)); ?></span>
                                        <span class="badge <?php echo e($isOutOfStock ? 'bg-danger' : 'bg-secondary'); ?>"><?php echo e($product->category); ?></span>
                                    </div>
                                </div>
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('recipient-type-btn')) {
            ...
            if (recipientType === 'self') {
                const customerName = document.getElementById('customerName').value || '<?php echo e($customerName); ?>';
