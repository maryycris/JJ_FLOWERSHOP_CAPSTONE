    ...
    <div class="mx-auto" style="max-width: 800px;">
        <div class="card shadow mb-4">
            <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><strong>Total Amount:</strong> <span class="h5 text-success">₱<?php echo e(number_format($invoice->total_amount, 2)); ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Payment Form -->
                <form method="POST" action="<?php echo e(route('invoices.payment.process', $invoice)); ?>" id="paymentForm">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" 
                                       value="<?php echo e($invoice->total_amount); ?>" step="0.01" min="0.01" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="<?php echo e(route('invoices.show', $invoice)); ?>" class="btn btn-outline-secondary">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePaymentMode(mode) {
        ...
        if (amountField.value === '') {
            amountField.value = '<?php echo e($invoice->total_amount); ?>';
        }
    }
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/invoices/payment.blade.php ENDPATH**/ ?>