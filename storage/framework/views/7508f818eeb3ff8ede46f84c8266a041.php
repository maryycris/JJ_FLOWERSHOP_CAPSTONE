            ...
            <div class="card shadow-sm" style="border:0;">
                <div class="card-body p-0" style="background:#fff;">
                    <div class="p-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e6f0e6; background:#e6f5e6;">
                        ...
                        <div class="ms-2 small text-muted">Quotations / <?php echo e(sprintf('%05d', $order->id)); ?></div>
                    ...
                    <div class="px-3 py-2 d-flex align-items-center gap-2" style="border-bottom:1px solid #e6f0e6;">
                        <a href="<?php echo e(route('clerk.orders.walkin.create_invoice', $order)); ?>" class="btn btn-success">Validate</a>
...
<?php echo $__env->make('layouts.clerk_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/clerk/orders/walkin/quotation.blade.php ENDPATH**/ ?>