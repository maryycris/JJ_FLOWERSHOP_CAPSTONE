        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" style="background: #e6f4ea;">
                    <h3 class="card-title mb-0" style="font-size: 1.1rem; font-weight: 600;">Order Details - #<?php echo e($order->id); ?></h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Order Number:</strong> #<?php echo e($order->id); ?></p>
                                            ...
                                            <p><strong>Status:</strong> 
                                                <?php if($order->order_status): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="badge" style="background-color: #ffc107; color: black;"><?php echo e(ucfirst($order->order_status)); ?></span>
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <span class="badge" style="background-color: #ffc107; color: black;"><?php echo e(ucfirst($order->status ?? 'Pending')); ?></span>
                                                <?php endif; ?>
                                            </p>
                                            <p><strong>Payment Method:</strong>
                                                ...
                                                <?php else: ?>
                                                    <span class="badge" style="background-color: #66bb6a; color: white;"><?php echo e(strtoupper($order->payment_method ?? 'N/A')); ?></span>
                                                <?php endif; ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <table class="table table-bordered">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <?php if($product->code): ?>
                                                                    <br><small class="text-muted">SKU: <?php echo e($product->code); ?></small>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td><strong class="text-success">₱<?php echo e(number_format($order->total_price, 2)); ?></strong></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Delivery Date:</strong> <?php echo e($order->delivery->delivery_date ? \Carbon\Carbon::parse($order->delivery->delivery_date)->format('M d, Y') : 'N/A'); ?></p>
                                            <p><strong>Delivery Address:</strong> <?php echo e($order->delivery->delivery_address ?? 'N/A'); ?></p>
                                            <?php if($order->delivery->driver_decision): ?>
                                                <p><strong>Driver Decision:</strong> 
                                                    <span class="badge" style="background-color: <?php echo e($order->delivery->driver_decision === 'accepted' ? '#28a745' : '#dc3545'); ?>; color: white;">
                                        ...
                                        <div class="col-md-6">
                                            <?php if($order->delivery->proof_of_delivery_image): ?>
                                                ...
                                                <p><strong>Delivered on:</strong> 
                                                    <small class="text-muted">
                                                        <?php echo e($order->delivery->proof_of_delivery_taken_at ? \Carbon\Carbon::parse($order->delivery->proof_of_delivery_taken_at)->format('M d, Y g:i A') : 'N/A'); ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if($order->delivery->driver): ?>
                                                <p><strong>Driver:</strong> <?php echo e($order->delivery->driver->name); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Reference Number:</strong> <?php echo e($latestProof->reference_number ?? 'N/A'); ?></p>
                                            <p><strong>Payment Method:</strong> 
                                                <span class="badge" style="background-color: #4caf50; color: white;"><?php echo e(strtoupper($latestProof->payment_method)); ?></span>
                                            </p>
                                            <p><strong>Status:</strong> 
                                                <span class="badge" style="background-color: <?php echo e($latestProof->status === 'approved' ? '#28a745' : ($latestProof->status === 'pending' ? '#ffc107' : '#dc3545')); ?>; color: <?php echo e($latestProof->status === 'pending' ? 'black' : 'white'); ?>;">
                                                    <?php echo e(ucfirst($latestProof->status)); ?>

                                                </span>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <?php if($latestProof->image_path): ?>
                                                <p><strong>Screenshot/Receipt:</strong></p>
                                                <img src="<?php echo e(asset('storage/' . $latestProof->image_path)); ?>" alt="Payment Proof" class="img-fluid rounded" style="max-width: 200px; max-height: 200px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if($isOnDelivery || $isCOD): ?>
                            <div class="card">
                                <div class="card-header" style="background: #e6f4ea;">
                                    <h5><?php if($isOnDelivery): ?> Invoice Options <?php else: ?> Order Slip <?php endif; ?></h5>
                                </div>
                                <div class="card-body">
                                    <a href="<?php echo e(route('admin.orders.invoice.view', $order->id)); ?>" class="btn btn-primary btn-sm mb-2 w-100" target="_blank">
                                        <i class="fas fa-eye"></i> View <?php echo e($isOnDelivery ? 'Invoice' : 'Order Slip'); ?>

                                    </a>
                                    <a href="<?php echo e(route('admin.orders.invoice.download', $order->id)); ?>" class="btn btn-success btn-sm w-100">
                                        <i class="fas fa-download"></i> Download <?php echo e($isOnDelivery ? 'PDF' : 'Order Slip'); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center" style="padding: 1rem;">
                ...
                <div class="row text-start" style="font-size: 0.85rem; margin-top: 0.5rem;">
                    <div class="col-md-6">
                        <p style="margin-bottom: 0.25rem;"><strong>Order #:</strong> <?php echo e($order->id); ?></p>
                        <p style="margin-bottom: 0.25rem;"><strong>Customer:</strong> <?php echo e($order->user->name ?? 'N/A'); ?></p>
                        <p style="margin-bottom: 0.25rem;"><strong>Delivered on:</strong> <?php echo e($order->delivery->proof_of_delivery_taken_at ? \Carbon\Carbon::parse($order->delivery->proof_of_delivery_taken_at)->format('M d, Y g:i A') : 'N/A'); ?></p>
                    </div>
                    <div class="col-md-6">
                        <p style="margin-bottom: 0.25rem;"><strong>Confirmed by:</strong> <?php echo e($order->delivery->driver->name ?? 'Delivery Driver'); ?></p>
                        <p style="margin-bottom: 0.25rem;"><strong>Delivery Address:</strong> <?php echo e($order->delivery->delivery_address ?? 'N/A'); ?></p>
