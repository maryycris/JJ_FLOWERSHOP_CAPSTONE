...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/clerk-styles.css')); ?>">
        ...
        <nav class="clerk-navbar-bg">
            <div class="clerk-navbar-content">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo e(route('clerk.notifications.index')); ?>" class="text-white text-decoration-none" title="Notifications">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="clerkProfileDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(route('clerk.dashboard')); ?>">Dashboard</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('clerk.profile.edit')); ?>">Edit Profile</a></li>
