                    ...
                    <div class="card h-100 light-green-card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span class="badge bg-primary fs-6"><?php echo e(number_format($onlineOrdersCount ?? 0)); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-shop me-2"></i>Walk-in Orders</span>
                                <span class="badge bg-info fs-6"><?php echo e(number_format($walkinOrdersCount ?? 0)); ?></span>
                            </div>
                            <hr class="my-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <strong>Total Orders</strong>
                                <strong class="text-success"><?php echo e(number_format(($onlineOrdersCount ?? 0) + ($walkinOrdersCount ?? 0))); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
