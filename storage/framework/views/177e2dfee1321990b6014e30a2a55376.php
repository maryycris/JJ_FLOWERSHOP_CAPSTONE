    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <strong><?php echo e($order->delivery->delivery_date ? \Carbon\Carbon::parse($order->delivery->delivery_date)->format('M d, Y') : 'N/A'); ?></strong>
                        </div>
                        <div class="col-6">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div>
                            ...
                            <br><small class="text-muted">Qty: <?php echo e($product->pivot->quantity); ?></small>
                        </div>
                        <div class="text-end">
                            <strong>₱<?php echo e(number_format($product->price * $product->pivot->quantity, 2)); ?></strong>
                        </div>
                    </div>
            ...
            <div class="d-flex gap-2 mb-3">
                ...
                <button class="btn btn-warning flex-fill" onclick="returnOrder(<?php echo e($order->id); ?>)">
