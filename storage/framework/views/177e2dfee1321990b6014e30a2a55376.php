    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="<?php echo e(route('driver.orders.index')); ?>" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <?php if($order->order_status === 'returned'): ?>
                        ...
                        <?php else: ?>
                            <span class="badge bg-secondary fs-6"><?php echo e(ucfirst($order->order_status)); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if($order->order_status === 'returned'): ?>
                        <div class="mt-2">
                            ...
                            <strong class="text-warning"><?php echo e($order->returned_at ? $order->returned_at->format('M d, Y H:i') : 'N/A'); ?></strong>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 pb-3 border-bottom">
                        ...
                        <div class="row">
                            <div class="col-6 mb-2">
                                ...
                                <strong style="font-size: 0.85rem;"><?php echo e($order->delivery->delivery_date ? \Carbon\Carbon::parse($order->delivery->delivery_date)->format('M d, Y') : 'N/A'); ?></strong>
                            </div>
                            <div class="col-6 mb-2">
                                <small class="text-muted" style="font-size: 0.8rem;">Delivery Time:</small><br>
                                <strong style="font-size: 0.85rem;"><?php echo e($order->delivery->delivery_time ?? 'N/A'); ?></strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div>
                                <strong style="font-size: 0.85rem;"><?php echo e($product->name); ?></strong>
                                <br><small class="text-muted" style="font-size: 0.75rem;">Qty: <?php echo e($product->pivot->quantity); ?></small>
                            </div>
                            <div class="text-end">
                                <strong style="font-size: 0.85rem;">₱<?php echo e(number_format($product->price * $product->pivot->quantity, 2)); ?></strong>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <strong class="text-success" style="font-size: 0.9rem;">₱<?php echo e(number_format($order->total_price, 2)); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="flex-grow-1 ms-2">
                            ...
                            <br><strong><?php echo e(ucfirst($history->status)); ?></strong>
                            <?php if($history->message): ?>
                                <br><small class="text-muted"><?php echo e($history->message); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="d-flex gap-2 mb-3">
                <button class="btn btn-success flex-fill" onclick="showCompleteModal(<?php echo e($order->id); ?>)">
...
<?php echo $__env->make('layouts.driver_mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/driver/orders/show.blade.php ENDPATH**/ ?>