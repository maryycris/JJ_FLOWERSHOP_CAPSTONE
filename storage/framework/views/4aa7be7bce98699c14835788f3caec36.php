        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    ...
                    <div class="p-3" style="border-bottom:1px solid #e6f0e6;">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <a href="<?php echo e(route('admin.orders.walkin.sales_order', $order->id)); ?>" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center justify-content-center" title="Back" aria-label="Back" style="width:34px;height:34px;padding:0;">
                ...
                <div class="ms-2 small text-muted">
                    <div>Quotations / <?php echo e(sprintf('%05d', $order->id)); ?></div>
                    <div class="fw-bold text-primary">
                        <?php if($order->salesOrder): ?>
                            <a href="<?php echo e(route('admin.sales-orders.show', $order->id)); ?>" class="text-decoration-none text-primary" style="cursor: pointer;">
                                <?php echo e(str_replace('-', '', $order->salesOrder->so_number)); ?>

                            </a>
                        <?php else: ?>
                            SO<?php echo e(sprintf('%05d', $order->id)); ?>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="<?php echo e(route('admin.sales-orders.index')); ?>" class="btn btn-outline-secondary">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="d-flex align-items-center gap-1 ms-3">
                                    ...
                                    <i class="bi bi-chevron-right text-muted"></i>
                                    <div class="badge <?php echo e(request('view') === 'moves' ? 'bg-success' : 'bg-secondary'); ?> text-white px-2 py-1" id="readyBadge">Ready</div>
                                    <i class="bi bi-chevron-right text-muted"></i>
                                    <div class="badge <?php echo e($order->order_status === 'approved' || $order->order_status === 'completed' || $order->order_status === 'on_delivery' ? 'bg-success' : 'bg-secondary'); ?> text-white px-2 py-1" id="doneBadge">Done</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="px-3 pt-3 pb-4">
                        <div class="row g-0">
                            <div class="col-md-6">
                                <div class="p-3">
                                    <h4 class="fw-bold mb-2"><?php echo e($inventoryMovement ? $inventoryMovement->movement_number : 'OUT / 0001'); ?></h4>
                            ...
                            <div class="col-md-6">
                                <div class="p-3">
                                    ...
                                    <div class="small">
                                        ...
                                        ?>
                                        <div class="mb-1"><?php echo e($customerName); ?></div>
                                        <?php if($emailFromNotes): ?>
                                            <div class="mb-1"><?php echo e($emailFromNotes); ?></div>
                                        <?php endif; ?>
                                        ...
                                        <?php if($canRedeemDiscount): ?>
                                            <div class="mt-2 p-2" style="background: #d4edda; border: 1px solid #c3e6cb; border-radius: 4px;">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <small class="text-success fw-bold"><?php echo e($loyaltyStamps); ?>/5 stamps</small>
                                                </div>
                                                <div class="mt-1">
                                                    <small class="text-success fw-bold">
                                                        <i class="bi bi-gift-fill me-1"></i>50% OFF on <?php echo e($discountedProduct->name); ?>!
                                                    </small>
                                                    <br>
                                                    <small class="text-success">
                                                        Discount: ₱<?php echo e(number_format($loyaltyDiscountAmount, 2)); ?>

                                                    </small>
                                                </div>
                                            </div>
                                        <?php elseif($canEarnStamp): ?>
                                            <div class="mt-2 p-2" style="background: #f8f9fa; border-radius: 4px;">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <small class="fw-semibold text-primary">Loyalty Card</small>
                                                    <?php if($loyaltyCard): ?>
                                                        <small class="text-muted"><?php echo e($loyaltyStamps); ?>/5 stamps</small>
                                                    <?php else: ?>
                                        ...
                                        <div class="mt-2">
                                            <div class="mb-1"><span class="fw-semibold">Schedule Date:</span> <span class="text-muted"><?php echo e(optional($order->created_at)->format('m/d/Y')); ?></span></div>
                                            <div><span class="fw-semibold">Order Number:</span> <span class="text-muted"><?php echo e(sprintf('%05d', $order->id)); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr class="<?php echo e($isInsufficientStock ? 'table-warning' : ''); ?>">
                                                <td>
                                                    ...
                                                    <?php if($isInsufficientStock): ?>
                                                        <small class="text-warning"><?php echo e($stockMessage); ?></small>
                                                    <?php else: ?>
                                                        <small class="text-success"><?php echo e($stockMessage); ?></small>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <input type="number" class="form-control form-control-sm demand-input" value="<?php echo e($demand); ?>" min="0" data-product-id="<?php echo e($product->id); ?>">
                                                </td>
                                                <td>
                                                    <input type="number" class="form-control form-control-sm quantity-input" value="<?php echo e($quantityToProvide); ?>" min="0" data-product-id="<?php echo e($product->id); ?>">
                                                </td>
                                                <td>
                                                    <select class="form-select form-select-sm uom-select" data-product-id="<?php echo e($product->id); ?>">
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <button type="button" class="btn btn-outline-success" onclick="validateProduct(<?php echo e($product->id); ?>)" title="Validate">
                                                            <i class="bi bi-check-circle"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-outline-warning" onclick="editProduct(<?php echo e($product->id); ?>)" title="Edit">
                                                            <i class="bi bi-pencil"></i>
                                                        </button>
                                                        <button type="button" class="btn btn-outline-danger" onclick="removeProduct(<?php echo e($product->id); ?>)" title="Remove">
                                                ...
                                                <?php else: ?>
                                                    <div class="text-muted">
                                                        ...
                                                        <small class="text-muted">
                                                            ...
                                                            <a href="<?php echo e(route('admin.products.index')); ?>" target="_blank" class="text-decoration-none">
                                                                Product Catalog
                                                            </a> 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (confirmValidateBtn) {
        confirmValidateBtn.addEventListener('click', function() {
            ...
            fetch(`<?php echo e(route('admin.orders.walkin.validate.confirm', $order->id)); ?>`, {
                method: 'POST',
                headers: {
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-start">
                ...
                <p><strong>Movement Number:</strong> <?php echo e($inventoryMovement ? $inventoryMovement->movement_number : 'OUT / 0001'); ?></p>
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '<?php echo e(route("admin.orders.walkin.validate", $order->id)); ?>?view=moves';
        }
    });
}
...
function printOrder() {
    ...
    const orderData = {
        orderNumber: '<?php echo e(sprintf("%05d", $order->id)); ?>',
        movementNumber: '<?php echo e($inventoryMovement ? $inventoryMovement->movement_number : "OUT / 0001"); ?>',
        customerName: '<?php echo e($order->user->name ?? "Walk-in Customer"); ?>',
        deliveryAddress: '<?php echo e($order->delivery->delivery_address ?? ""); ?>',
        orderDate: '<?php echo e($order->created_at->format("m/d/Y")); ?>'
    };
