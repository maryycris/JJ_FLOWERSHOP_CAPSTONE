        ...
        <div class="card-header" style="background-color: white; border-bottom: 1px solid #d9ecd9;">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?php echo e(route($panel . '.orders.create')); ?>" class="btn btn-outline-primary btn-sm-custom me-3">New</a>
                    <h5 class="page-title mb-0 text-gray-800" style="margin: 0;">Sales Order <?php echo e($salesOrder ? $salesOrder->so_number : 'SO-XXXXX'); ?></h5>
                </div>
                <div class="d-flex align-items-center gap-3">
                    <a href="<?php echo e(route($panel . '.orders.walkin.validate', $order->id)); ?>?view=moves" class="d-flex flex-column align-items-center text-decoration-none" style="cursor: pointer;" title="Click to view delivery moves" id="truckIconLinkStatic">
            ...
            <div class="d-flex gap-2 mt-3">
                <form method="POST" action="<?php echo e(route($panel . '.orders.invoice.create', $order->id)); ?>">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card-body p-0">
            ...
            <div class="row g-0 border-bottom" style="border-color: #d9ecd9 !important;">
                ...
                <div class="col-md-2" style="background-color: white; border-right: 1px solid #d9ecd9;">
                    ...
                    <div class="p-3">
                        <div class="fw-semibold info-text"><?php echo e($order->user->name); ?></div>
                        <div class="text-muted" style="font-size: 0.8rem;"><?php echo e($order->user->contact_number ?? 'N/A'); ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="background-color: white; border-right: 1px solid #d9ecd9;">
                    ...
                    <div class="p-3">
                        ...
                        ?>
                        <div class="info-text"><?php echo e($email ?? 'N/A'); ?></div>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="background-color: white; border-right: 1px solid #d9ecd9;">
                    ...
                    <div class="p-3">
                        <?php if($order->delivery): ?>
                            <div class="info-text"><?php echo e($order->delivery->delivery_address); ?></div>
                        <?php else: ?>
                ...
                <div class="col-md-2" style="background-color: white; border-right: 1px solid #d9ecd9;">
                    ...
                    <div class="p-3">
                        <div class="info-text"><?php echo e($order->created_at->format('m/d/Y')); ?></div>
                    </div>
                </div>
                    ...
                    <table class="table mb-0 table-body">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $order->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="info-text" style="padding: 0.4rem 0.75rem; border-right: 1px solid #d9ecd9;"><?php echo e($product->name); ?></td>
                                    <td class="info-text" style="padding: 0.4rem 0.75rem; border-right: 1px solid #d9ecd9;"><?php echo e($product->description); ?></td>
                                    <td class="info-text" style="padding: 0.4rem 0.75rem; border-right: 1px solid #d9ecd9;"><?php echo e($product->pivot->quantity); ?></td>
                                    <td class="info-text" style="padding: 0.4rem 0.75rem; border-right: 1px solid #d9ecd9;">PCS</td>
                                    <td class="info-text" style="padding: 0.4rem 0.75rem;">₱<?php echo e(number_format($product->price, 2)); ?></td>
                                </tr>
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/sales-orders/show.blade.php ENDPATH**/ ?>