...
<div class="card shadow-lg mb-4" style="border: none; border-radius: 16px; background: #f7faf7;">
    <div class="card-body text-center">
        ...
        <p class="display-5 fw-bold mb-1" style="color: #216f21;" id="deliveryCount"><?php echo e((isset($toDeliver) ? $toDeliver->count() : 0) + (isset($pendingAcceptance) ? $pendingAcceptance->count() : 0)); ?></p>
...
<div class="card shadow-lg mb-4" style="border: none; border-radius: 16px; border-left: 4px solid #17a2b8;">
    ...
    <div class="card-body p-0">
        ...
        <div class="border-bottom p-3 order-card-clickable" id="pendingOrder<?php echo e($order->id); ?>" style="border-color: #e9ecef !important; cursor: pointer; transition: background-color 0.2s;" onclick="viewOrderDetails(<?php echo e($order->id); ?>)" onmouseover="this.style.backgroundColor='#d1ecf1'" onmouseout="this.style.backgroundColor='transparent'">
