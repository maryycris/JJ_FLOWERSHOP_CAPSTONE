            ...
            <div class="card-body">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-warning btn-sm" onclick="showReturnModal(<?php echo e($order->id); ?>, '<?php echo e($order->user->first_name); ?> <?php echo e($order->user->last_name); ?>', '<?php echo e($order->delivery_address); ?>', '₱<?php echo e(number_format($order->total_price, 2)); ?>', '<?php echo e($order->created_at->format('M d, Y')); ?>')">
