    ...
    <div class="chat-container" style="width: 100%; max-width: 1000px; max-height: 67vh;">
        ...
        <div class="users-sidebar">
            ...
            <div class="p-3" style="height: calc(100% - 60px); overflow-y: auto;">
                ...
                <a href="<?php echo e(route('admin.chatbox', ['user_id' => $user->id])); ?>" 
                   class="user-item d-block text-decoration-none <?php echo e($selectedUserId == $user->id ? 'active' : ''); ?>">
        ...
        <div class="chat-area">
            <?php if($selectedUserId): ?>
                <?php $selectedUser = $users->where('id', $selectedUserId)->first(); ?>
                <div class="chat-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="opacity-75"><?php echo e(ucfirst($selectedUser->role)); ?></small>
                        </div>
                    </div>
                </div>
                    ...
                    <?php if($messages && count($messages)): ?>
                        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex <?php echo e($msg->sender_id == auth()->id() ? 'justify-content-end' : 'justify-content-start'); ?>">
                                <div class="message-bubble <?php echo e($msg->sender_id == auth()->id() ? 'message-sent' : 'message-received'); ?>">
                                    <div class="message-sender">
                                        <?php echo e($msg->sender_id == auth()->id() ? 'You' : $users->where('id', $msg->sender_id)->first()->name); ?>

                                    </div>
                                    <div class="message-text"><?php echo e($msg->message); ?></div>
                                    <div class="message-time text-end"><?php echo e($msg->created_at->format('M d, H:i')); ?></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                ...
                <div class="chat-input-area">
                    <form action="<?php echo e(route('admin.chatbox.send')); ?>" method="POST" class="d-flex w-100" style="gap: 10px;">
                        <?php echo csrf_field(); ?>
