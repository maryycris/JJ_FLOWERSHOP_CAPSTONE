            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    ...
                    <div class="px-3 pt-3 pb-4">
                        ...
                        <?php if($order->customBouquets->isNotEmpty()): ?>
                            <div class="mt-4">
                                ...
                                <div class="table-responsive" style="border:1px solid #ffc107;">
                                    <?php $__currentLoopData = $order->customBouquets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bouquet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="p-3 border-bottom">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h6 class="mb-0">Custom Bouquet (Qty: <?php echo e($orderQty); ?>)</h6>
                                            ...
                                            <?php if(!empty($components)): ?>
                                                            ...
                                                            <table class="table table-sm mb-0">
                                                                ...
                                                                <tbody>
                                                                    <?php $__currentLoopData = $components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $component): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            <td><strong><?php echo e($component['category']); ?></strong></td>
                                                                            <td><?php echo e($component['name']); ?></td>
                                                                            <td><?php echo e($component['quantity']); ?></td>
                                                ...
                                                <div class="mt-2">
                                                    <small class="text-muted">
                                                        <i class="fas fa-info-circle"></i> Total Components: <?php echo e(count($components)); ?> | Order Quantity: <?php echo e($orderQty); ?> bouquet(s)
                                                    </small>
                                                </div>
                                            <?php else: ?>
                                                <div class="text-muted">
