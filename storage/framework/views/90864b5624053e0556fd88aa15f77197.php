...
<div class="container-fluid" style="margin-left: 0; padding-left: 20px; padding-right: 20px;">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col-3">
                            ...
                            <h4 class="text-success"><?php echo e($returnStats['total_returned']); ?></h4>
                        </div>
                        <div class="col-3">
                            <h6 class="text-muted">Pending Review</h6>
                            <h4 class="text-warning"><?php echo e($returnStats['pending_review']); ?></h4>
                        </div>
                        <div class="col-3">
                            <h6 class="text-muted">Approved</h6>
                            <h4 class="text-info"><?php echo e($returnStats['approved']); ?></h4>
                        </div>
                        <div class="col-3">
                            <h6 class="text-muted">Resolved</h6>
                            <h4 class="text-success"><?php echo e($returnStats['resolved']); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="tab-content" id="returnTabsContent">
        ...
        <div class="tab-pane fade show active" id="all-returns" role="tabpanel">
            <?php echo $__env->make('admin.returns.partials.returns_table', ['orders' => $returnedOrders, 'filter' => 'all'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        
        <!-- Pending Returns -->
        <div class="tab-pane fade" id="pending-returns" role="tabpanel">
            <?php echo $__env->make('admin.returns.partials.returns_table', ['orders' => $pendingOrders, 'filter' => 'pending'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        
        <!-- Approved Returns -->
        <div class="tab-pane fade" id="approved-returns" role="tabpanel">
            <?php echo $__env->make('admin.returns.partials.returns_table', ['orders' => $approvedOrders, 'filter' => 'approved'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-2 col-6 mb-3">
                    <div class="card status-card-clickable" style="background-color: #ffc107; border: 2px solid #ffc107; cursor: pointer;" onclick="filterByStatus('all')" data-status="all">
                        <div class="card-body text-center">
                            <h4 class="mb-1 text-dark fw-bold"><?php echo e($returnStats['total_returned']); ?></h4>
                ...
                <div class="col-md-2 col-6 mb-3">
                    <div class="card status-card-clickable" style="background-color: #17a2b8; border: 2px solid #17a2b8; cursor: pointer;" onclick="filterByStatus('pending')" data-status="pending">
                        <div class="card-body text-center">
                            <h4 class="mb-1 text-white fw-bold"><?php echo e($returnStats['pending_review']); ?></h4>
                ...
                <div class="col-md-2 col-6 mb-3">
                    <div class="card status-card-clickable" style="background-color: #28a745; border: 2px solid #28a745; cursor: pointer;" onclick="filterByStatus('approved')" data-status="approved">
                        <div class="card-body text-center">
                            <h4 class="mb-1 text-white fw-bold"><?php echo e($returnStats['approved']); ?></h4>
                ...
                <div class="col-md-2 col-6 mb-3">
                    <div class="card status-card-clickable" style="background-color: #dc3545; border: 2px solid #dc3545; cursor: pointer;" onclick="filterByStatus('rejected')" data-status="rejected">
                        <div class="card-body text-center">
                            <h4 class="mb-1 text-white fw-bold"><?php echo e($returnStats['rejected']); ?></h4>
                ...
                <div class="col-md-2 col-6 mb-3">
                    <div class="card status-card-clickable" style="background-color: #6c757d; border: 2px solid #6c757d; cursor: pointer;" onclick="filterByStatus('resolved')" data-status="resolved">
                        <div class="card-body text-center">
                            <h4 class="mb-1 text-white fw-bold"><?php echo e($returnStats['resolved']); ?></h4>
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/returns/index.blade.php ENDPATH**/ ?>